      ...
      <Container>
        <div className="flex flex-col items-center px-8 xl:px-14 2xl:flex-row 2xl:px-0 2xl:justify-between">
          <div className="w-full">
            ...
            {/* Section Description */}
            <div className="text-center 2xl:text-left xl:text-xl sm:space-x-13 pb-12 md:space-x-15 lg:mx-72 xl:mx-0 xl:mr-32 lg:space-x-10 xl:space-x-15 2xl:space-x-10">
