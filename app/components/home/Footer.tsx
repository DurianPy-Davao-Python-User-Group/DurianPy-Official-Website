  ...
  return (
    <footer className="bg-gradient-utd-saturatedGreen-transparent rounded-t-[100px] pt-4 ">
      <Container>
        ...
        {/* Social Media Links */}
        <div className="flex flex-row items-center gap-4 md:w-full md:gap-6 justify-center -mt-14 ">
          ...
          >
            <svg
              ...
              viewBox="0 0 719 160"
              fill="currentColor"
              className="w-16 h-16 sm:w-24 sm:h-24 sm:mb-1 md:w-40 md:h-40 text-primary group-hover:text-[#FBFF00] transition-transform duration-300 group-hover:scale-110"
            >
