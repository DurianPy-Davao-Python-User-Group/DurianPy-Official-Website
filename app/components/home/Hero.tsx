  ...
  return (
    <>
      <section className="relative bg-dark-green overflow-clip">
        {/* Background elements */}
        <div>
          <div className="absolute inset-0 bg-[url('/image/rectangle.svg')] bg-cover bg-no-repeat bg-center top-[45%] blur-md scale-x-[2] md:scale-y-[1.3] lg:top-[65%] lg:scale-y-[1.7] height-1024:top-[50%]" />
          ...
          <Image
            ...
            alt="a"
            priority
            className="absolute left-[70%] top-[50%] right-[6%] scale-[115%] md:scale-100 md:right-[15%] rotate-180 md:rotate-[200deg] blur-sm w-auto h-auto md:hidden lg:block xl:top-[50%] xl:left-[80%] xl:scale-[130%] width-1912:left-[85%] width-1912:scale-150 height-1000:top-[60%] height-1366:top-[70%]"
          />
          <div
