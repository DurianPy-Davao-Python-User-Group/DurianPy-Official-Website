        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center p-10">
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 352 177"
              fill="none"
              className="absolute bottom-0 px-2 z-20 max-w-full rounded-xl"
            >
              <path
          ...
          >
            ...
            <div className="flex justify-center">
              <svg
                ...
                viewBox="0 0 176 195"
                fill="none"
                className="absolute bottom-5 z-20 max-h-[13rem] max-w-full"
              >
                <path
          ...
          >
            ...
            <div className="flex justify-center">
              <svg
                ...
                viewBox="0 0 252 252"
                fill="none"
                className="absolute bottom-0 px-2 z-20 max-h-64 max-w-full"
              >
                <path
