...
export const Route = createFileRoute('/speak')({
  head: () => ({
    meta: [
      {
        title: 'Speak at DurianPy | DurianPy',
      },
    ],
  }),
  component: SpeakDetails,
});
  ...
  return (
    <section>
      <div className="flex-column max-w-7xl mx-auto pl-8 md:pl-12 lg:pl-16">
        ...
        <div className="flex flex-row items-center justify-start w-full mt-8 md:mt-10 lg:mt-10">
          ...
          <div className="w-1/2">
            ...
            <Button
              ...
              className="bg-yellow-500 text-black font-medium py-2 md:py-2 lg:py-3 px-4 md:px-5 lg:px-7 [@media(max-width:320px)]:text-[6px] text-[10px] md:text-[14px] lg:text-[18px] rounded-full hover:bg-yellow-600 transition-all duration-300 ease-out hover:scale-105 cursor-pointer"
            >
