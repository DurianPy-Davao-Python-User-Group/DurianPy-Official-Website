...
import Card from '@/components/sigs/card'

export const Route = createFileRoute('/sigs')({
  head: () => ({
    meta: [
      {
        title: 'Special Interest Groups | DurianPy',
      },
    ],
  }),
  component: Sigs,
    ...
    <div className="max-w-7xl mx-auto px-4">
      <div className="relative flex flex-col justify-center mt-28 2xl:mt-60">
        <div className="flex flex-col items-center">
          ...
          <button
            className="my-6 md:my-8 lg:my-10 mx-auto block bg-primary text-black text-[8px] md:text-xl leading-3 md:leading-none font-bold rounded-full px-2 md:px-4 lg:px-8 py-1 md:py-2 lg:py-4 border border-transparent hover:bg-opacity-50 hover:border-primary hover:text-primary transition-colors cursor-pointer"
            onClick={() =>
