...
export function Sponsors() {
  const sponsors: SponsorshipProps[] = [
    {
      name: 'Mugna Tech',
      logo: '/assets/images/sponsor-logos/mugna-logo.png',
      logoMobile: '/assets/images/sponsor-logos/mugna-logo.png',
      description:
    ...
    {
      name: 'Codev',
      logo: '/assets/images/sponsor-logos/codev-logo.png',
      logoMobile: '/assets/images/sponsor-logos/codev-logo.png',
      description:
    ...
    },
    {
      ...
      logo: '/assets/images/sponsor-logos/ingenuity-logo.png',
      logoMobile: '/assets/images/sponsor-logos/ingenuity-logo-mobile.png',
      description:
    ...
    {
      name: 'PythonPH',
      logo: '/assets/images/sponsor-logos/pythonph-logo.png',
      logoMobile: '/assets/images/sponsor-logos/pythonph-logo-mobile.png',
      description:
    ...
    {
      name: 'Stace',
      logo: '/assets/images/sponsor-logos/stace-logo.svg',
      logoMobile: '/assets/images/sponsor-logos/stace-logo.svg',
      description:
